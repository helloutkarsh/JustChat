...
import com.santara.justchat.databinding.ActivityUserSetupBinding;
...
public class UserSetup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog = new ProgressDialog(UserSetup.this);
        ...
        binding.continueDPBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                dialog.show();
                     ...
                     reference.putFile(selectedImage).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                         ...
                         public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                             if(task.isSuccessful()){
                                 ...
                                 String phone = auth.getCurrentUser().getPhoneNumber();
                                 String name = binding.userNameTextView.getText().toString();
                                 User user = new User(uid,name, phone, "none" );
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(data!=null){
            if(data.getData()!=null){
                binding.addDP.setImageURI(data.getData());
